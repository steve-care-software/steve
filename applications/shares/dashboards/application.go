...
import (
	"github.com/steve-care-software/steve/applications/shares/dashboards/fetches"
	executions "github.com/steve-care-software/steve/domain/commands/executions/shares/dashboards"
	"github.com/steve-care-software/steve/domain/commands/executions/shares/dashboards/failures"
	"github.com/steve-care-software/steve/domain/commands/executions/shares/dashboards/successes"
...
func (app *application) Execute(dashboard inputs.Dashboard, stack stacks.Stack) (executions.Dashboard, error) {
	name := dashboard.Name()
