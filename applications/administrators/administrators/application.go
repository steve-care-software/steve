...
func (app *application) Execute(instance inputs.Administrator, stack stacks.Stack) (executions.Administrator, error) {
	...
	if instance.IsInstance() {
		...
		exec, err := app.instanceApp.Execute(ins, stack)
		if err != nil {
			return nil, err
		}
